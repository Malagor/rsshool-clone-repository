...
// import petsArray from '../model/petsArray';
// import PetsGaleryTable from "../classes/PetsGaleryTable";

const pathToFile = '../assets/pets.json';
...
class PetsGalery {
  ...
  toHTML = (pet, index) => {
    const {name, img} = pet;
    return `
        <li class="gallery-item" data-id="${index}">
